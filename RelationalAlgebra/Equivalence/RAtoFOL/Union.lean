...
theorem toFOL.evalT_def.u_def_eq (h : RA.Query.isWellTyped dbi.schema (.u q₁ q₂))
  ...
  (ih₂ : FOL.Query.evaluateT dbi (toFOL dbi.schema q₂) = RA.Query.evaluateT dbi q₂) :
    FOL.Query.evaluateT dbi (toFOL dbi.schema (q₁.u q₂)) = RA.Query.evaluateT dbi (q₁.u q₂) := by
      ...
      simp [*, toFOL.schema_def, FOL.Query.evaluateT, FOL.Query.RealizeMin.and_def, FOL.BoundedQuery.Realize, ← ih₁, ← ih₂]
      ext t
