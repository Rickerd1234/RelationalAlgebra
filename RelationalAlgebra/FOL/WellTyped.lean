...
@[simp]
theorem BoundedQuery.isWellTyped.and_comm {n} {q₁ q₂ : BoundedQuery n} (h : (and q₁ q₂).isWellTyped) :
  (and q₂ q₁).isWellTyped
    := by simp_all [Finset.union_comm]

@[simp]
theorem BoundedQuery.isWellTyped.and_from_both {n} {q₁ q₂ : BoundedQuery n} (h₁ : q₁.isWellTyped) (h₂ : q₂.isWellTyped) :
  (and q₁ q₂).isWellTyped
